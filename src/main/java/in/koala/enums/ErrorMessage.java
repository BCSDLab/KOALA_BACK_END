...
public enum ErrorMessage {
	...
	NAVER_LOGIN_EXCEPTION(125, "네이버 로그인 오류"),
	...
	PROFILE_SCOPE_EXCEPTION(134, "oauth2 sns 로부터 제공되는 정보가 부족합니다"),
	SNS_LOGIN_EXCEPTION(135, "구글 로그인 오류"),
	KAKAO_LOGIN_EXCEPTION(136, "카카오 로그인 오류"),
